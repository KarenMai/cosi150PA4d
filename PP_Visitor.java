...
public class PP_Visitor implements Visitor {
     ...
     public Object visit(Program node, Object data) {
          ...
          String classDeclList = (String) node.c.accept(this, indent + 1);
          return mainClass + "\n" + classDeclList;
     }
     ...
     public Object visit(ClassDecl node, Object data) {
          int indent = (int) data;
          String id = (String) node.i.accept(this, indent);
          String varDeclList = (String) node.v.accept(this, indent);
          String methodDeclList = (String) node.m.accept(this, indent);
          String v = "";
          if (node.v != null) {
     ...
     public Object visit(While node, Object data) {
          ...
          return indentString(indent) + "while (" + expr + ")" + statement;
     }
     ...
     public Object visit(ArrayAssign node, Object data) {
          ...
          data = id + "[" + exp1 + "] = " + exp2 + ";\n";
          return indentString(indent) + data;
     }
     ...
     public Object visit(NewArray node, Object data) {
          int indent = (int) data;
          String expression = (String) node.e.accept(this, indent);
     ...
     public Object visit(ClassDeclList node, Object data) {
          int indent = (int) data;
          String classDecl = (String) node.c.accept(this, indent);
          String classList = "";
          if (node.clist != null) {
               classList = (String) node.clist.accept(this, indent);
          }
          return classDecl + "\n\n" + classList;
     }
